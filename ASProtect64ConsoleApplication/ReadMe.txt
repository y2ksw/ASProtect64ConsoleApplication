========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto ASProtect64ConsoleApplication
========================================================================

La creazione guidata applicazione ha creato questa applicazione ASProtect64ConsoleApplication.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione ASProtect64ConsoleApplication.


ASProtect64ConsoleApplication.vcxproj
...
ASProtect64ConsoleApplication.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato ASProtect64ConsoleApplication.pch e il file dei tipi precompilato StdAfx.obj.
